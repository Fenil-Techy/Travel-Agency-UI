    ...
    return(
        <div className="max-w-7xl mx-auto px-4">
            <div className="flex flex-col justify-center items-center gap-3">
                <h1 className="subheading text-xs lg:text-lg xl:text-xl font-semibold">Top Selling</h1>
                <h1 className="font-volkhov text-2xl lg:text-4xl xl:text-5xl font-bold">Top Destinations</h1>
            </div>
            <div className="flex flex-col lg:flex-row lg:gap-20 xl:flex-row xl:gap-20 justify-center items-center mt-10 gap-10">
