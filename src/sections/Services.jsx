    ...
    return (
        <div className="max-w-7xl mx-auto ">
            <div className="flex flex-col justify-center items-center gap-3">
                <h1 className="subheading text-xs font-semibold">CATEGORY</h1>
                <h1 className="font-volkhov text-2xl font-bold">We Offer Best Services</h1>
            </div>
            <div className="flex flex-col justify-center items-center mt-10 gap-10">
                <div className="flex flex-col justify-center items-center w-60 px-4 py-8 shadow-[0_8px_15px_rgba(0,0,0,0.1)] rounded-2xl">
                ...
                <div className="flex flex-col justify-center items-center w-60 p-2  px-4 py-6 shadow-[0_8px_15px_rgba(0,0,0,0.1)] rounded-2xl">
                ...
                <div className="flex flex-col justify-center items-center w-60 p-2  px-4 py-8 shadow-[0_8px_15px_rgba(0,0,0,0.1)] rounded-2xl">
